...
With recipes, I can process a video in one line `/video-tools any-file.mp4`. I can also share it as a URL, `goose://recipe?config=...`, that will deep link into Goose to add the recipe when someone clicks on it.
