...
excerpt: >-
  I started a new role at the beginning of April, and they ship you equipment,
  including a new keyboard...
...
tags:
  ...
  - ergonomics
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fg7z1ueuhxcqrqlb11tbd.JPG
canonical_url: https://www.nickyt.co/blog/review-logitech-ergo-k860-wireless-keyboard
dev_to_slug: logitech-ergo-k860-wireless-keyboard-nef
...
![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen](/assets/images/posts/_uploads_articles_npt3fthk51vvi162ismz.png)
...
![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen where the F12 key was clicked, displaying the options you have for the F12 key](/assets/images/posts/_uploads_articles_1u16uxq6guqv7jumn57y.png)

There are more options if you click on the More link.

![Logitech LogiOptions software for Logitech devices, currently displaying a picture of the ERGO K860 keyboard settings screen where the F12 key was clicked, displaying the expanded options you have for the F12 key](/assets/images/posts/_uploads_articles_krwnaic4tu6414b5omjx.png)
...
![LogiOptions software open on the keyboard settings showing keys outlined in white that can be remapped including the Print Screen key](/assets/images/posts/_uploads_articles_55gqpfbgmfj6gpwempty.png)
...
![The keystroke assignment window to remap the Print Screen key](/assets/images/posts/_uploads_articles_osai6yn70ofwtkvrkv4f.png)
...
![Three keys labeled 1, 2, and 3 with a tiny computer icon on each on the ERGO K860 keyboard to switch between devices](/assets/images/posts/_uploads_articles_5vxnwtzdopn7dwsmmi4o.png) 
