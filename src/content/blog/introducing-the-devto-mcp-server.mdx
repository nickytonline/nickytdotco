...
tags:
  ...
  - ai
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fpuvgni3pd332f3uqdwhi.jpg
canonical_url: "https://www.nickyt.co/blog/introducing-the-devto-mcp-server"
dev_to_slug: "introducing-the-devto-mcp-server-42jg"
...
<Embed url="https://github.com/nickytonline/dev-to-mcp" />
...
![getting latest react articles using the dev.to mcp server in VS Code](/assets/images/posts/_uploads_articles_pn4jrhuh22hzoev8iz4q.gif)
...
![dev.to MCP server running in VS Code](/assets/images/posts/_uploads_articles_lzgklq2yswknlrh3lv9y.gif)

In the [Pomerium MCP app demo](https://github.com/pomerium/mcp-app-demo).

![dev.to MCP server running in the Pomerium MCP app demo](/assets/images/posts/_uploads_articles_ws6g3hy499m5glc9zxgz.png)

In [Goose](https://github.com/block/goose):

![dev.to MCP server running in Goose](/assets/images/posts/_uploads_articles_ulwvcfxq2rvtxw9ymvjb.gif)
...
!["dev MCP server settings in VS Code"](/assets/images/posts/_uploads_articles_rnybtg68ehrogk7q01oq.png)
...
<Embed url="https://github.com/modelcontextprotocol/typescript-sdk" />
