...
excerpt: >-
  I recently got to hang with Peli de Halleux (@pelikhan) to discuss the
  GenAIScript project.          ...
...
<GenericEmbed url="https://dev.to/pelikhan/unlocking-the-power-of-prompts-a-gentle-introduction-to-genaiscript-34nn" />
...
<GenericEmbed url="https://www.youtube.com/watch?v=aeXQ2MJ0Ye0" />
