...
excerpt: >-
  So I've written about how I automated content updates for my blog before. I
  even gave a talk on...
...
tags:
  ...
  - git
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fn5zbeeuatd9c42b1etvc.jpg
canonical_url: "https://www.nickyt.co/blog/automate-and-auto-merge-pull-requests-using-github-actions-and-the-github-cli"
dev_to_slug: "automate-and-merge-pull-requests-using-github-actions-and-the-github-cli-4lo6"
...
![Allow auto-merge checked in a GitHub repository's general settings](/assets/images/posts/_uploads_articles_ydpifg55ey6b6rnvh1yc.png)
...
![Automatically delete head branches checked in a GitHub repository's general settings](/assets/images/posts/_uploads_articles_5ybamm8gve0cl96p1l38.png)
...
![Pull request section of branch protection settings in a GitHub repository](/assets/images/posts/_uploads_articles_s8gl2yej8bmk1nu1jz6o.png)

3. Require checks to pass

![Required checks pane of branch protection settings in a GitHub repository](/assets/images/posts/_uploads_articles_d9xwgx9uatfq8psjcefy.png)
