...
tags:
  - browsers
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fthepracticaldev.s3.amazonaws.com%2Fi%2Ftz6e8mu5mw2o2rx66egy.png
canonical_url: https://www.nickyt.co/blog/evaluating-the-new-microsoft-edge
dev_to_slug: evaluating-the-new-microsoft-edge-4m1j
...
<TwitterEmbed tweetId="1180654867850903552" />

<TwitterEmbed tweetId="1181245028280213504" />
...
![Install MS Edge for iOS](/assets/images/posts/_uploads_articles_a4vqpx41s7x2m4r795hu.png)
...
![MS Edge on iOS not loading GitHub feed](/assets/images/posts/_uploads_articles_66dzckutdat8wcld24ev.png)
...
![MS Edge on iOS warning about being an old version of Safari on GitHub site](/assets/images/posts/_uploads_articles_7cnnkab5a6a8wadwgxve.png)
...
![MS Edge Browse Later Screen on iOS](/assets/images/posts/_uploads_articles_k9letjw1cttmb9spn1r5.png) 

![MS Edge Browse Later Help Page for iOS](/assets/images/posts/_uploads_articles_ym4t4cutum7ddjkyezmy.png)
...
![MS Edge on iOS reporting legitimate site as unsafe](/assets/images/posts/_uploads_articles_5v7xgaeqot2qemt4gwkk.png)
