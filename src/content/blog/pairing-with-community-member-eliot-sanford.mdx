...
tags:
  ...
  - javascript
cover_image: null
canonical_url: https://www.nickyt.co/blog/pairing-with-community-member-eliot-sanford
dev_to_slug: pairing-with-community-member-eliot-sanford-f7a
...
<YouTubeEmbed videoId="LBDqggawwNE" />

Eliot is still working on the issue, so feel free to follow its progress.

<GitHubEmbed url="https://github.com/forem/forem/issues/4807" />
