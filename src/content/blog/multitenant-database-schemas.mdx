...
excerpt: >-
  I recently got to hang with Jamie Barton (@notrab) from the Turso team. We
  discussed Multitenant...
...
tags:
  ...
  - turso
cover_image: null
canonical_url: https://www.nickyt.co/blog/multitenant-database-schemas
dev_to_slug: multitenant-database-schemas-4ofc
...
![Running command `turso db list` and receiving the error Error: user not logged in, please login with turso auth login](/assets/images/posts/_uploads_articles_vc0qi1kzn9vm14taffkd.png)
