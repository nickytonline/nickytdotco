...
excerpt: >-
  The GitHub CLI is an indispensable tool as a project maintainer or contributor
  on GitHub. It can...
...
tags:
  ...
  - productivity
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F9arpr3kib5ci5pmgmda5.jpeg
canonical_url: "https://www.nickyt.co/blog/boost-productivity-with-the-github-cli"
dev_to_slug: "boost-productivity-with-the-github-cli-2mne"
...
![Someone's head exploding like the exploding head emoji](/assets/images/posts/_uploads_articles_xdqnv6j7m6joilp4qdjj.png)
...
![GitHub CLI gh auth login command running](/assets/images/posts/_uploads_articles_chype8akpqm392qfzs3d.png)
...
![The GitHub CLI prompting with the following, What is your preferred protocol for Git operations? Use arrows to move, type to filter HTTPS or SSH](/assets/images/posts/_uploads_articles_wo07iigwynxvqyuil64w.png)

Next, it will ask you to publish your public key to GitHub. This is safe to do and you can proceed.

![GitHub CLI prompting to upload your public SSH key](/assets/images/posts/_uploads_articles_ilooaemam9dgcc756k4k.png)

It will prompt for a title for the key. Using the default value of "GitHub CLI" is fine.

![The GitHub CLI prompting for a title for the SSH public key](/assets/images/posts/_uploads_articles_lnappw8c5adv3pf0ic9o.png)

### Login via HTTPS

If you choose HTTPS, you'll be asked to authenticate Git with your GitHub credentials.

![The GitHub CLI prompting to log in with your GitHub credentials](/assets/images/posts/_uploads_articles_c4bfodupmj8oba15ocj1.png)
...
![The GitHub CLI prompting to log in to GitHub via a browser or a token](/assets/images/posts/_uploads_articles_fqu5mwmyc0lbl6ckkgr0.png)
...
![The GitHub CLI outputting a code you need to copy to finish the login process](/assets/images/posts/_uploads_articles_cgimazlzyobj7kgnwaa6.png)

Paste or type in the code and press the Continue button.

![GitHub.com device activation screen](/assets/images/posts/_uploads_articles_acbc8cs604tjtiq8cfmm.png)

Next, you'll be asked to Authorize GitHub. Click the Authorize GitHub button.

![The authorize GitHub CLI screen on github.com](/assets/images/posts/_uploads_articles_8wa8xzio1a5f9wsysuw9.png)
...
![Multifactor confirm access screen using GitHub mobile](/assets/images/posts/_uploads_articles_ieoj4z63o8x071dq6n2u.png)
...
![GitHub.com confirmation screen that the device was connected successfully](/assets/images/posts/_uploads_articles_7i87s3jjk3we0fzwxzv1.png)

And if you go back to the command line, you should see something similar to this.

![GitHub CLI confirming that you are logged in](/assets/images/posts/_uploads_articles_furcqwnfulnyksu9s8gx.png)
...
![Running the GitHub CLI checkout command, gh co 2062, to check out pull request 2062 from a repository](/assets/images/posts/_uploads_articles_7zo4ef9ckl76g0dtdd43.gif)
...
![A repository's main page on github.com with a call to action to create a pull request from a branch pushed to github.com](/assets/images/posts/_uploads_articles_mt6fqypoarfmu7er8c3t.png)
...
![Running the GitHub CLI create pull request command, gh pr create, to create a new pull request for a repository](/assets/images/posts/_uploads_articles_qcmmnrwl2stvg9h5rxuy.gif)

## Creating or Pushing a New Repository to GitHub

In the past, I always used to create a new repository from GitHub.com.

![User menu on GitHub.com open with the menu item New Repository highlighted](/assets/images/posts/_uploads_articles_u65e1ghs25onuatof93o.png)
...
![The GitHub CLI prompting user what to do with Create a new repository from scratch selected](/assets/images/posts/_uploads_articles_57cf58p1s48mzsa743zg.png)
...
![The GitHub CLI prompting for a name for the repository](/assets/images/posts/_uploads_articles_1wqvv4u62musbve5c8dq.png)
...
![The GitHub CLI prompting for a repository owner](/assets/images/posts/_uploads_articles_tz8knqytjiqvlu5ll974.png)

Add a description for the repository, e.g. `test` or leave it blank. It's not required.

![The GitHub CLI prompting for a description](/assets/images/posts/_uploads_articles_nbouh9hz8w6gcyzba8sr.png)

Next, set the visibility of the repository. It can be public (default), private, or internal.

![The GitHub CLI prompting for the visibility of the repository](/assets/images/posts/_uploads_articles_mfjbrw0o9okqoh7h9rie.png)

Since this is a test repository, I'm going to set it to private.

![The GitHub CLI running with privacy selected for the visibility](/assets/images/posts/_uploads_articles_20lt2a8mwt52qaank5e2.png)

Next, you'll be asked to create a README file. Type `y` and press the <kbd>ENTER</kbd> key.

![The GitHub CLI prompting to create a README](/assets/images/posts/_uploads_articles_mtn95z644i4hzvs1ok44.png)

You'll be prompted to add a gitignore file. Type `y` and press the <kbd>ENTER</kbd> key.

![The GitHub CLI prompting for to create a gitignore file](/assets/images/posts/_uploads_articles_rf7p7j75fyb8qmw543ez.png)
...
![Node selected as the language for the gitignore template](/assets/images/posts/_uploads_articles_nxf3ntackdyr2bh0ujfh.png)

You'll be asked to add a license. Type `y` and press the <kbd>ENTER</kbd> key.

![The GitHub CLI prompting to create a license](/assets/images/posts/_uploads_articles_ufrcfi5oaanzbnyp5d85.png)
...
![MIT License selected in the GitHub CLI](/assets/images/posts/_uploads_articles_ys75il7rmt51wvm40fk2.png)

A quick check will ask if you want to create the repository on GitHub. Type `y` and press the <kbd>ENTER</kbd> key to proceed.

![The GitHub CLI summarizing all the selections made, prompting the user to create the repository on GitHub](/assets/images/posts/_uploads_articles_fek4c3bxo06ul695g5v2.png)

Next, you'll be asked if you want to clone the repository locally. 

![The GitHub CLI asking the user if they want to clone the repository](/assets/images/posts/_uploads_articles_3cu0ea66kzsji32qfh0j.png)
...
![The GitHub CLI, with the Push an existing local repository to GitHub option selected](/assets/images/posts/_uploads_articles_bdglfgwcshd21yk116qn.png)
...
![The GitHub CLI prompting to enter the path to a local repository](/assets/images/posts/_uploads_articles_aqvhfmobqsk8odltby91.png)
...
![The GitHub CLI, prompting a user to enter a repository name](/assets/images/posts/_uploads_articles_rhjs3n4xgcznhdy5d303.png)
...
![The GitHub CLI prompting for a repository owner](/assets/images/posts/_uploads_articles_m5mirrkm3g1ifyzted5n.png)

Next, you'll be asked to add a description. You can add one or leave it blank. It's up to you.

![The GitHub CLI prompting for a description for the repository](/assets/images/posts/_uploads_articles_v6pttkuwhk15u8namc96.png)

Next, you'll be asked to set the visibility of the repository. It can be public (default), private, or internal.

![The GitHub CLI prompting to select the visibility of the repository](/assets/images/posts/_uploads_articles_83hk4addzxsefe3osund.png)

Next, you'll be asked if you want to set a remote. Press enter to say yes (the default)

![The GitHub CLI prompting to add a remote for the repository](/assets/images/posts/_uploads_articles_bh42zxnalpa5vcngoi4d.png)
...
![The GitHub CLI prompting to name the remote](/assets/images/posts/_uploads_articles_whiw5y2pjp1yfylug7nt.png)
...
![The GitHub CLI pushing the current branch to the origin remote on GitHub](/assets/images/posts/_uploads_articles_unodjzvt3r8shsehhfyu.png)
