...
tags:
  ...
  - netlify
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fthepracticaldev.s3.amazonaws.com%2Fi%2Fjivsyirs8gft16kuji62.png
canonical_url: "https://www.nickyt.co/blog/update-dependencies-with-dependabot-cypress-and-netlify"
dev_to_slug: "update-dependencies-with-dependabot-cypress-and-netlify-3lkf"
...
<TwitterEmbed tweetId="1161457130530123776" />
...
![Branch Protection Rule](/assets/images/posts/_uploads_articles_h5f02iehfz4jlu2p1dg3.png)
...
![Cypress Test Selection](/assets/images/posts/_uploads_articles_o2mkg284xtj32alrj0ge.png)

If you’re Gatsby site is running the test should pass.

![Cypress Test Runner with a Test Passing](/assets/images/posts/_uploads_articles_5dasrrtove90dbw90718.png)
...
![Dependabot Automatic PR merging settings](/assets/images/posts/_uploads_articles_y41agaxm0dim2c45ba8h.png)
...
![Dependabot Merged PR](/assets/images/posts/_uploads_articles_eot199766u7m1zmipwq4.png)

If you’d like to see the whole setup of this on my site, check out my repository on GitHub.

<GitHubEmbed url="https://github.com/nickytonline/iamdeveloper.com" />
