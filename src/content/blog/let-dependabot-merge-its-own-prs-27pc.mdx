...
excerpt: >-
  Dependabot opens PRs automatically. That part most people have set up. But
  then those PRs just sit...
...
This isn't Dependabot-specific, but it is required for this to work. Without it, the `gh pr merge --auto` command in the workflow will fail.
...
`GITHUB_TOKEN` is automatically available in every GitHub Actions workflow, no setup needed on your end.
