...
tags:
  ...
  - webdev
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Folzaevg5khtiad835vke.png
canonical_url: "https://www.nickyt.co/blog/set-up-a-git-precommit-hook-with-husky-lint-staged-prettier-and-stylelint"
dev_to_slug: "stuff-i-always-set-up-for-frontend-work-56h2"
...
![A screen shot of a lint error](/assets/images/posts/_i_nyu8r5kj3mu5arl37mns.png)
...
![prettier code formatting tool in action formatting some code](/assets/images/posts/_i_1b5cv01xqxhzn9w0jdhi.gif)
...
![A Git pre-commit hook running in a terminal before a commit](/assets/images/posts/_i_x64xahqayl7uj5xiqapb.png)  
...
![A Git pre-commit hook running lint-staged tasks](/assets/images/posts/_i_27q7nzts52vzyym5pmpg.png)
