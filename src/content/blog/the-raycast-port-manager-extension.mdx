...
excerpt: >-
  If you aren’t a Raycast user, definitely check it out. I was a fan of Alfred
  for years, but moved to...
...
tags:
  ...
  - tooling
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fbm89rrn9i2ut38zkzm0r.jpg
canonical_url: https://www.nickyt.co/blog/the-raycast-port-manager-extension
dev_to_slug: the-raycast-port-manager-extension-lca
...
![Raycast open with the word &quot;port&quot; in the search returning results for the Port Manager extension](/assets/images/posts/_uploads_articles_1dtjslii1ur6j1qmau0t.png)
...
![Raycast menu open showing the processes running on ports with a context menu for a port with the Kill… option highlighted ](/assets/images/posts/_uploads_articles_ubqh6ow7eardjgqi9fwb.png)
