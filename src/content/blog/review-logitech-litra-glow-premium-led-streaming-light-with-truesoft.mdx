...
excerpt: >-
  So I live stream on Twitch mainly, although I have started to stream to my
  YouTube channel as...
...
tags:
  ...
  - lighting
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fwqenc79moc5h6ohdr8nd.png
canonical_url: "https://www.nickyt.co/blog/review-logitech-litra-glow-premium-led-streaming-light-with-truesoft"
dev_to_slug: "review-logitech-litra-glow-premium-led-streaming-light-with-truesoft-2p60"
...
![My old lighting set up for live streaming](/assets/images/posts/_uploads_articles_exrqccl2pai6wfi3mejb.png)
...
![My monitor sitting on my desk with the Litra Glow sitting on top of it](/assets/images/posts/_uploads_articles_aehkg166yfdha0txwoha.png)

On the rear of the Litra Glow are physical buttons to turn it on, change brightness or change the colour temperature.

![Back of Litra Glow light showcasing it's physical buttons](/assets/images/posts/_uploads_articles_r6v66zm0fj9fshomq4vd.png)
...
![Litra Glow software turning off the light](/assets/images/posts/_uploads_articles_wk7hphgpljhn1xpne6u3.gif)

Tweaking the temperature of the light is super easy as well. You can adjust it manually or choose a preset.

![Litra Glow software manual temperature settings](/assets/images/posts/_uploads_articles_azx8dndnljaabn7t44ll.png)

I've currently been enjoying the Cozy Daylight preset.

![Temperature settings set to the Cozy Daylight preset](/assets/images/posts/_uploads_articles_44yabt1zvgwnn5l3w2m3.png)

You can also preview your camera to adjust the lighting.

![Selecting camera to use in Litra Glow software](/assets/images/posts/_uploads_articles_3mehj3mt1mo9zi1cjin2.png)

You can also set the resolution of the preview

![Camera preview in Litra Glow software](/assets/images/posts/_uploads_articles_e06rg09hm9l2c4da02mn.png)
