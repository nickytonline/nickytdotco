...
excerpt: >-
  I just finished Goose’s Advent of AI. Everything from CI automation to
  hand-gesture controlled apps...
...
tags:
  ...
  - cli
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F6yvhgeh5smo5its2ryjl.png
canonical_url: "https://www.nickyt.co/blog/what-makes-goose-different-from-other-ai-coding-agents"
dev_to_slug: "what-makes-goose-different-from-other-ai-coding-agents-2edc"
reading_time_minutes: 12
template: post
---
import Embed from "@/components/Embed.astro";

I just finished Goose’s [Advent of AI](https://adventofai.dev/). Everything from CI automation to hand-gesture controlled apps to creating model context protocol (MCP) servers with UI.

[![Me testing out my hand gesture project](/assets/images/posts/_uploads_articles_mpc0zvsraivv3qvkf4xu.png)](https://flightboard.nickyt.co/)
...
![Goose chat UI](/assets/images/posts/_uploads_articles_2j67b1zxr39c1f4gdcci.png)

![Model modal](/assets/images/posts/_uploads_articles_8jqapgv6kvetjuoxix4s.png)
...
![Recipe UI showing parameters](/assets/images/posts/_uploads_articles_gxi94yjbasoply9i5i00.png)
...
![Configuring a recipe as a slash command](/assets/images/posts/_uploads_articles_jb8c6k5dc8f8czc5z640.png)
...
![Wishing to hang with Snoop and Martha](/assets/images/posts/_uploads_articles_n8x9515ndgfeqb85jbos.png)
...
![auto-visualizer extension in action](/assets/images/posts/_uploads_articles_dxlv6tt4cy6o7th4q8g5.png)
...
![Geese infra](/assets/images/posts/_uploads_articles_7h5envbtewzeublll2v9.png)
