...
excerpt: >-
  The idea for this post came about while I was reviewing this pull request (PR)
  for OpenSauced.       ...
...
tags:
  ...
  - react
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Flijgw6h1zjd18tliwifs.png
canonical_url: "https://www.nickyt.co/blog/typescript-infer-types-to-avoid-explicit-types"
dev_to_slug: "infer-types-to-avoid-explicit-types-1pnn"
...
[![Image description](/assets/images/posts/_uploads_articles_ua2d5toq5zw880dxdwlg.png)](https://app.opensauced.pizza/javascript/dashboard/filter/recent)
...
![TypeScript complaining that the property 'svelte' is missing in type](/assets/images/posts/_uploads_articles_wub4v6h58nxn41l60te0.png)
...
![A TypeScript function returning a tuple even though the inferred type is not a tuple](/assets/images/posts/_uploads_articles_uhql5ip1rr8657kj46cy.png)
