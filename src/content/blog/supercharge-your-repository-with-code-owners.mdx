...
excerpt: >-
  As a maintainer of a repository, it’s in your best interest to automate
...
tags:
  ...
  - security
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fmb76rkwxnwmvnfi8labd.png
canonical_url: https://www.nickyt.co/blog/supercharge-your-repository-with-code-owners
dev_to_slug: supercharge-your-repository-with-code-owners-4clg
...
![GitHub user diivi commenting that they weren't aware of the CODEOWNERS feature](/assets/images/posts/_uploads_articles_hpkmx91y66efqaa62umv.png)
...
![A CODEOWNERS file with one team in it, @open-sauced/engineering](/assets/images/posts/_uploads_articles_0mg69ouah43ks9x3e0zh.png)

When someone creates a PR for that repository, that team is automatically added as a reviewer.

![Reviewers for a PR in the GitHub UI including the @open-sauced/engineering team](/assets/images/posts/_uploads_articles_hsevadw9yedmewgb0gya.png)
...
![GitHub PR review file where the UI says that the CODEOWNERS file is valid](/assets/images/posts/_uploads_articles_b85pfint60i7h5ph9eoi.png)
...
![A CODEOWNERS file with teams an individuals in it](/assets/images/posts/_uploads_articles_jqjiucgu564d6dx5n89s.png)
...
![Image description](/assets/images/posts/_uploads_articles_icix62kg1avsjy54enu2.png)
