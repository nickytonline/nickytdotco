...
excerpt: >-
  Open Graph (OG) images are a must if you're sharing content on the Internet.
  From sites like...
...
tags:
  ...
  - react
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8lwq8cpfabmtoh589glh.jpeg
canonical_url: "https://www.nickyt.co/blog/creating-an-og-image-using-react-and-netlify-edge-functions"
dev_to_slug: "creating-an-og-image-using-react-and-netlify-edge-functions-563a"
...
[![OG image for the OpenSauced workspace for jsr](/assets/images/posts/_uploads_articles_n9v3aq0eu0lsoxni8b3z.png)](https://app.opensauced.pizza/workspaces/760ea8ea-ebd3-4f9a-91ab-780384e3c102)
...
[![OG image for the huggingface/transformers repository](/assets/images/posts/_uploads_articles_7wrvyq2qqjwefpeklraf.png)](https://app.opensauced.pizza/s/huggingface/transformers)
...
![OG image for the OpenSauced workspace for jsr with sections outline in green squares denoting dynamic portions of the image](/assets/images/posts/_uploads_articles_32npdvf35s50hjl9r9iv.png)
...
![browser dev tools view of the metadata section of the &lt;head&gt; with OG image URLs outlined by green squares](/assets/images/posts/_uploads_articles_f059m9we4gkmb8ixx39v.png)
