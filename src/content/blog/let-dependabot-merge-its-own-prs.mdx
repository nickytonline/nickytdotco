...
excerpt: >-
  Update May 2026: Given there's an explosion of supply chain attacks recently,
  I decided to remove...
...
canonical_url: "https://www.nickyt.co/blog/let-dependabot-merge-its-own-prs"
dev_to_slug: "let-dependabot-merge-its-own-prs-27pc"
reading_time_minutes: 4
template: post
---
import Embed from "@/components/Embed.astro";

Update May 2026: Given there's an [explosion of supply chain attacks](https://www.reddit.com/r/cybersecurity/comments/1taposq/mass_npm_supply_chain_attack_hits_tanstack/) recently, I decided to remove this workflow from my own repo, so leaving this post here, but more for historical purposes. Even with the recommendations from March 2026 below, I just don't feel comfortable atm letting these auto-merge.
