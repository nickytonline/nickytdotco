...
excerpt: >-
  Last week, we launched our brand new Dev Cards with the OSCR (Open Source
  Contributor Rating)...
...
tags:
  ...
  - github
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fr5lksfacbj6jsab38lxq.png
canonical_url: "https://www.nickyt.co/blog/supercharge-your-github-profile-showcase-your-open-source-contributions"
dev_to_slug: "showcase-your-open-source-contributions-with-opensauced-dev-cards-2j0k"
...
![An OpenSauced User's avatar with the dev card button to the bottom right of it.](/assets/images/posts/_uploads_articles_q3faduepn8vdt571w2bg.png)

The card is interactive and can be flipped.

![My OpenSauced dev card](/assets/images/posts/_uploads_articles_4vyjcmg41113h3pgd3mh.gif)
...
![My GitHub README showcasing my OpenSauced Dev Card](/assets/images/posts/_uploads_articles_359o03keegpkdg9dns8y.png)
...
4. Add the following markdown to your README.md:
    ...
    ```markdown
    [![My OpenSauced Dev Card](./dev-card.png)](/assets/images/posts/_your_username)
    ```
