...
excerpt: >-
  This week brought a major upgrade to the frontend infrastructure for DEV.
  We've been on webpacker 3.x...
...
tags:
  ...
  - changelog
cover_image: >-
  /assets/images/posts/_dynamic_image_width=1000,height=420,fit=cover,gravity=auto,format=auto_https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fcc61ssp14pyl9of3i37y.jpg
canonical_url: "https://www.nickyt.co/blog/changelog-dev-upgraded-to-webpacker-4babel-7"
dev_to_slug: "changelog-dev-upgraded-to-webpacker-4-babel-7-1mm4"
...
<GitHubEmbed url="https://github.com/rails/webpacker" />
