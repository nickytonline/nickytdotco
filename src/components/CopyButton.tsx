...
const CopyButton = ({
  ...
  return (
    <>
      <button
        type="button"
        className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-border transition-colors hover:bg-background hover:text-brand focus:bg-background focus:text-brand"
        onClick={handleCopy}
        title={label}
      >
        {didCopy ? (
